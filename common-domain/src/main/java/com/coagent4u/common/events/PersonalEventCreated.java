...
public record PersonalEventCreated(
    ...
    public static PersonalEventCreated of(AgentId agentId, UserId userId, CorrelationId correlationId, EventId calendarEventId,
            TimeSlot timeSlot, String title) {
        return new PersonalEventCreated(agentId, userId, correlationId, calendarEventId, timeSlot, title, Instant.now());
    }
}

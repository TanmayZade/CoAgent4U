...
public record CalendarSourced(
    ...
    public static CalendarSourced of(AgentId agentId, UserId userId, CorrelationId correlationId, int eventCount) {
        return new CalendarSourced(agentId, userId, correlationId, eventCount, Instant.now());
    }
}

...
public record TaskFailed(
    ...
    public static TaskFailed of(AgentId agentId, UserId userId, CorrelationId correlationId, String taskType, String errorMessage) {
        return new TaskFailed(agentId, userId, correlationId, taskType, errorMessage, Instant.now());
    }
}
